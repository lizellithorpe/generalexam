...
becomes unbound during a simulation. For all $1800$ simulations, there are $179$ occurences of the loss of a binary companion. Stable systems 
more often than not retain their binary companion. In $93\%$ of systems that keep all 4 planets, the binary remains bound as well. In $100$ of the $179$ cases,
...
simulations have unstable planets, but $44\%$ of the subset simulations with a lost binary have undergone planet loss.
...
of their host star measure via the Rossiter-McLaughlin effect (\cite{ros24},) further complicates this picture, but also provides more evidence for a dynamical pathway 
