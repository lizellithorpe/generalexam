...
becomes unbound during a simulation. For all $1800$ simulations, there are $179$ occurences of the loss of a binary companion.
...
immediately observationally clear that a once-bound binary was the driver of past planetary dynamics.
Stable systems 
more often than not retain their binary companion. In $93\%$ of systems that keep all 4 planets, the binary remains bound as well. However, in around $100$ cases,
